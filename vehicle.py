...
def vehicle_data(num_vehicle):
    vehicle = []
    for VehicleID in range(1, num_vehicle + 1):
        ...
        vehicle.append((VehicleID, VehicleType, VehicleCompany, VehicleName, VehicleNumber))
    return vehicle
...
#    cursor.execute('DROP TABLE IF EXISTS vehicle')
    ...
    insert_query = '''INSERT INTO vehicle (VehicleID, VehicleType, VehicleCompany, VehicleName, VehicleNumber) VALUES(%s,%s,%s,%s,%s)'''
